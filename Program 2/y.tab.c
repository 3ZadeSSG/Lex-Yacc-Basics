...
{
  "$end", "error", "$undefined", "NUM", "ADD", "SUB", "MUL", "EQU",
  "LEFT_P", "RIGHT_P", "SEMI_C", "ID", "'\\n'", "$accept", "SL", "S", "E",
  "T", "F", YY_NULLPTR
};
#endif
...
{
      10,    -6,    -4,    11,     3,     0,    -5,    13,    17,    -6,
      11,    -6,    -3,    11,    -6,    12,    -6,    11,    11,    16,
      -6,    13,    -6,    17,    -6,    -6
};
...
{
      14,    17,    12,     1,    10,     2,    20,    16,     3,    19,
      13,     4,    21,     1,     1,     2,     2,    17,     3,     3,
      17,     4,    11,    18,    22,    25,    15,    24,     0,     0,
       0,    23
};

static const yytype_int8 yycheck[] =
{
       0,     4,     3,     3,     8,     5,     9,    12,     8,    10,
       7,    11,    13,     3,     3,     5,     5,     4,     8,     8,
       4,    11,    11,     6,    12,     9,     5,    18,    -1,    -1,
      -1,    17
};
...
{
       0,     3,     5,     8,    11,    14,    15,    16,    17,    18,
       8,    11,    16,     7,     0,    15,    12,     4,     6,    16,
       9,    16,    12,    17,    18,     9
};
...
#line 38 "logic.y" /* yacc.c:1646  */
    {generate_3_IMC((yyvsp[-2].symp)->name,(yyvsp[0].number),"",""); (yyvsp[-2].symp)->value=(yyvsp[0].number);}
#line 1269 "y.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 41 "logic.y" /* yacc.c:1646  */
    {(yyval.number)=new_temp();generate_3_IMC((yyval.number),(yyvsp[-2].number)," + ",(yyvsp[0].number));}
...
#line 47 "logic.y" /* yacc.c:1646  */
    {strcpy((yyval.number),"-");strcat((yyval.number),(yyvsp[-1].number));}
