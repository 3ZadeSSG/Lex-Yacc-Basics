...
{
  "$end", "error", "$undefined", "NUM", "LESS_THAN", "GREATER_THAN",
  "ASSIGN", "NOT_EQUAL", "LEFT_P", "RIGHT_P", "ID", "'\\n'", "$accept",
  "SL", "S", "E", "T", "F", YY_NULLPTR
};
#endif
...
{
       8,    -8,    -2,    14,     7,     0,    -7,     9,    15,    -8,
      14,    -8,    -4,    14,    -8,    17,    -8,    14,    14,    18,
      -8,     9,    -8,    15,    -8,    -8
};
...
{
       0,    13,     0,     0,    12,     0,     0,     5,     7,     9,
       0,    12,     0,     0,     1,     0,     2,     0,     0,     0,
      10,     4,     3,     6,     8,    11
};
...
{
      14,    17,    12,     1,    16,    20,    10,     2,     3,    19,
       4,     1,    21,    13,    17,     2,     3,     1,     4,    18,
      23,     2,     3,    17,    11,    15,     0,    25,    22,    24
};

static const yytype_int8 yycheck[] =
{
       0,     5,     3,     3,    11,     9,     8,     7,     8,    10,
      10,     3,    13,     6,     5,     7,     8,     3,    10,     4,
      17,     7,     8,     5,    10,     5,    -1,     9,    11,    18
};
...
{
       0,     3,     7,     8,    10,    13,    14,    15,    16,    17,
       8,    10,    15,     6,     0,    14,    11,     5,     4,    15,
       9,    15,    11,    16,    17,     9
};
...
#line 1260 "y.tab.c" /* yacc.c:1646  */
  ...
  case 4:
#line 38 "logic.y" /* yacc.c:1646  */
    {
 generate_3_IMC((yyvsp[-2].symp)->name,(yyvsp[0].number),"","");
...
#line 44 "logic.y" /* yacc.c:1646  */
 ...
 generate_3_IMC((yyval.number),(yyvsp[-2].number)," > ",(yyvsp[0].number));
}
